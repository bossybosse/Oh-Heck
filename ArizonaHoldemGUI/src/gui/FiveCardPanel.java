...
/**
 * Panel for displaying best hands
 * 
 * @author Richard Bosse, Jenna Franco
 * 
 */
@SuppressWarnings("serial")
public class FiveCardPanel extends JPanel {
	...
	public FiveCardPanel() {
		...
		Dimension dims = new Dimension(NUM_OF_CARDS * (CARD_WIDTH + PADDING)
